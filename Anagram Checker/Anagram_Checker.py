...
if length in word_length_lists:
    ...
    if word_to_check in word_length_lists[length]:
        for word in word_length_lists[length]:
            ...
            if all(letter in word for letter in word_to_check) and all(
                letter in word_to_check for letter in word
            ):
        ...
        print(
            "I don't recognise {} as a word, hence I don't believe there are any anagrams for it".format(
                word_to_check
            )
        )
        exit()
